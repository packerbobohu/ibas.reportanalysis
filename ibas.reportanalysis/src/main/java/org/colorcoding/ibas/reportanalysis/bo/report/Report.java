...
public class Report extends BusinessObject<Report> implements IReport {
    ...
    */
    ...
    public static final IPropertyInfo<emReportType> PROPERTY_TYPE = registerProperty(PROPERTY_TYPE_NAME, emReportType.class, MY_CLASS);
    ...
    * @return 值
    */
    @XmlElement(name = PROPERTY_TYPE_NAME)
    public final emReportType getType() {
        return this.getProperty(PROPERTY_TYPE);
    }
    ...
    * @param value 值
    */
    public final void setType(emReportType value) {
        this.setProperty(PROPERTY_TYPE, value);
    }
    ...
    */
    ...
    public static final IPropertyInfo<String> PROPERTY_SQLSTRING = registerProperty(PROPERTY_SQLSTRING_NAME, String.class, MY_CLASS);
    ...
    */
    ...
    public static final IPropertyInfo<String> PROPERTY_SERVER = registerProperty(PROPERTY_SERVER_NAME, String.class, MY_CLASS);
    ...
    */
    ...
    public static final IPropertyInfo<String> PROPERTY_USERNAME = registerProperty(PROPERTY_USERNAME_NAME, String.class, MY_CLASS);
    ...
    */
    ...
    public static final IPropertyInfo<String> PROPERTY_PASSWORD = registerProperty(PROPERTY_PASSWORD_NAME, String.class, MY_CLASS);
    ...
    */
    ...
    public static final IPropertyInfo<String> PROPERTY_ADDRESS = registerProperty(PROPERTY_ADDRESS_NAME, String.class, MY_CLASS);
    ...
    * 
    */ 
    public static final IPropertyInfo<IReportParameters> PROPERTY_REPORTPARAMETERS = registerProperty(PROPERTY_REPORTPARAMETERS_NAME, IReportParameters.class, MY_CLASS);
    /**
    * 获取-报表参数集合
    * 
    * @return 值
