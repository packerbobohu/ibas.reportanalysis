...
@XmlType(name = ReportParameter.BUSINESS_OBJECT_NAME, namespace = MyConsts.NAMESPACE_BO)
public class ReportParameter extends BusinessObject<ReportParameter> implements IReportParameter {
    ...
    */
    ...
    public static final IPropertyInfo<emReportParameterType> PROPERTY_TYPE = registerProperty(PROPERTY_TYPE_NAME, emReportParameterType.class, MY_CLASS);
    ...
    */
    ...
    public final emReportParameterType getType() {
    ...
    * @param value 值
    */
    public final void setType(emReportParameterType value) {
    ...
    */
    ...
    public static final IPropertyInfo<String> PROPERTY_DESCRIPTION = registerProperty(PROPERTY_DESCRIPTION_NAME, String.class, MY_CLASS);
